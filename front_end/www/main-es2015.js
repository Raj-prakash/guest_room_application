...
const routes = [
    { path: '', redirectTo: 'tabs', pathMatch: 'full', canLoad: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    {
        path: 'auth',
...
module.exports = __webpack_require__(/*! D:\angular\House-Rent-master\frontend\src\main.ts */"./src/main.ts");
