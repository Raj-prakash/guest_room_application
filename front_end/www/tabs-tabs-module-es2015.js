...
let ServerService = class ServerService {
    ...
    getAllData() {
        if (this.cookieService.get('email') !== '') {
            this.httpClient
                .post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].custom.ALL_DATA_URL, { email: this.cookieService.get('email') }, { observe: 'response' })
                .subscribe((response) => {
    ...
    getLoggedData() {
        if (this.cookieService.get('email') !== '') {
            this.httpClient
                .post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].custom.USER_DATA_URL, { email: this.cookieService.get('email') }, { observe: 'response' })
                .subscribe((response) => {
    ...
    get getProfilePhoto() {
        this.httpClient
            .post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].custom.USER_AUTH_DATA, { email: this.cookieService.get('email') }, { observe: 'response' })
            .subscribe((response) => {
...
let DetailsPage = class DetailsPage {
    constructor(modalControl, navParams) {
...
DetailsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./details.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/tabs/details/details.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./details.page.scss */ "./src/app/tabs/details/details.page.scss")).default]
    }),
...
const routes = [
    {
        ...
        children: [
            {
                path: 'self',
                loadChildren: () => __webpack_require__.e(/*! import() | self-self-module */ "self-self-module").then(__webpack_require__.bind(null, /*! ./self/self.module */ "./src/app/tabs/self/self.module.ts")).then((m) => m.SelfPageModule),
            },
            {
                path: 'others',
                loadChildren: () => __webpack_require__.e(/*! import() | others-others-module */ "others-others-module").then(__webpack_require__.bind(null, /*! ./others/others.module */ "./src/app/tabs/others/others.module.ts")).then((m) => m.OthersPageModule),
            },
            {
                path: 'rented',
                loadChildren: () => __webpack_require__.e(/*! import() | rented-rented-module */ "rented-rented-module").then(__webpack_require__.bind(null, /*! ./rented/rented.module */ "./src/app/tabs/rented/rented.module.ts")).then((m) => m.RentedPageModule),
            },
            {
                path: '',
    ...
    {
        path: 'details',
        loadChildren: () => __webpack_require__.e(/*! import() | details-details-module */ "details-details-module").then(__webpack_require__.bind(null, /*! ./details/details.module */ "./src/app/tabs/details/details.module.ts")).then((m) => m.DetailsPageModule),
    },
    {
        path: 'add/:sameOwnersData',
        loadChildren: () => __webpack_require__.e(/*! import() | add-add-module */ "add-add-module").then(__webpack_require__.bind(null, /*! ./add/add.module */ "./src/app/tabs/add/add.module.ts")).then((m) => m.AddPageModule),
    },
    {
        path: 'add',
        children: [
...
/* harmony import */ var _details_details_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./details/details.page */ "./src/app/tabs/details/details.page.ts");
    ...
    constructor(tabsService) {
        ...
        this.tabsService.getProfilePhoto.subscribe((res) => {
            ...
            this.userAuthData.image =
                src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].custom.PROFILE_IMAGE_URL + res.image;
        });
    }
    ngOnInit() {
        document
