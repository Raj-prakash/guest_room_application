...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-add-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTabsAddAddPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppDatabaseServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DatabaseService = /*#__PURE__*/function () {
      function DatabaseService(httpClient, cookieService, route) {
      ...
      _createClass(DatabaseService, [{
        key: "addUserFormToDatabase",
        value: function addUserFormToDatabase() {
          var _this = this;
          ...
          this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].custom.ADD_USER_DATA, tempFormData, {
            observe: 'response'
        ...
        key: "updateUserFormToDatabase",
        value: function updateUserFormToDatabase() {
          var _this2 = this;
          ...
          this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].custom.UPDATE_USER_DATA, tempFormData, {
            observe: 'response'
          }).subscribe(function (response) {
            if (response.body.status === 'ok') {
              // tost
    ...
    DatabaseService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_4__["CookieService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])], DatabaseService);
    /***/
  },
  ...
  /***/
  function srcAppTabsAddAddRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTabsAddAddModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    AddPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _add_routing_module__WEBPACK_IMPORTED_MODULE_5__["AddPageRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]],
  ...
  /***/
  function srcAppTabsAddAddPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTabsAddAddPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var AddPage = /*#__PURE__*/function () {
      function AddPage(fromBuilder, databaseService, route, activatedRouter) {
        ...
        value: function ngOnInit() {
          ...
          this.activatedRouter.params.subscribe(function (params) {
            if (Object.keys(params).length > 0) {
              _this3.addForm.get('ownerInfo.ownerName').setValue(JSON.parse(params.sameOwnersData).personal.ownerName);

              _this3.addForm.get('ownerInfo.mobile1').setValue(JSON.parse(params.sameOwnersData).personal.mobile1);

              _this3.addForm.get('ownerInfo.mobile2').setValue(JSON.parse(params.sameOwnersData).personal.mobile2);

              _this3.addForm.get('houseInfo.emptyRoom').setValue(JSON.parse(params.sameOwnersData).details.houseInfo.emptyRoom);

              _this3.addForm.get('houseInfo.roomDetails').setValue(JSON.parse(params.sameOwnersData).details.houseInfo.roomDetails);

              _this3.addForm.get('houseInfo.price').setValue(JSON.parse(params.sameOwnersData).details.houseInfo.price);

              _this3.addForm.get('address.street').setValue(JSON.parse(params.sameOwnersData).details.address.street);

              _this3.addForm.get('address.city').setValue(JSON.parse(params.sameOwnersData).details.address.city);

              _this3.addForm.get('address.state').setValue(JSON.parse(params.sameOwnersData).details.address.state);

              _this3.addForm.get('address.zip').setValue(JSON.parse(params.sameOwnersData).details.address.zip);

              _this3.addForm.get('isChecked').setValue(JSON.parse(params.sameOwnersData).details.renterInfo.isChecked);

              _this3.addForm.get('renterInfo.name').setValue(JSON.parse(params.sameOwnersData).details.renterInfo.renterInfo.name);

              _this3.addForm.get('renterInfo.mobile').setValue(JSON.parse(params.sameOwnersData).details.renterInfo.renterInfo.mobile);

              _this3.addForm.get('renterInfo.officeAddress').setValue(JSON.parse(params.sameOwnersData).details.renterInfo.renterInfo.officeAddress);

              _this3.addForm.get('renterInfo.permanentAddress').setValue(JSON.parse(params.sameOwnersData).details.renterInfo.renterInfo.permanentAddress);

              if (JSON.parse(params.sameOwnersData).details.renterInfo.isChecked === true) {
                _this3.checkedIt = 'true';
                _this3.isRanted = true;
              }

              if (JSON.parse(params.sameOwnersData).details.imagePath.length > 0) {
                _this3.imageArray = JSON.parse(params.sameOwnersData).details.imagePath;
                _this3.isImage = true;
                _this3.isUpdate = true;
              }

              localStorage.setItem('tempOldData', JSON.stringify(_this3.addForm.value));
            }
          });
        }
      }, {
    ...
    AddPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/tabs/add/add.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./add.page.scss */
      "./src/app/tabs/add/add.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _database_service__WEBPACK_IMPORTED_MODULE_3__["DatabaseService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]])], AddPage);
    /***/
  }
}]);
